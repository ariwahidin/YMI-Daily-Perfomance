...
<div class="row">
    <div class="col col-md-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0">Master destination</h4>

            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item"><a href="javascript: void(0);">Master destination</a></li>
                </ol>
            </div>
    ...
    <div class="col col-md-6">
        <div class="card">
            <div class="card-header">
                <button class="btn btn-primary" id="btnAdd">Add new destination</button>
            </div>
            <div class="card-body">
                <table id="user-table" class="display table table bordered" style="width:100%">
                    ...
                    <tbody>
                        <?php
                        $no = 1;
                        foreach ($destination->result() as $data) {
                        ?>
                            <tr>
                                <td><?= $no++ ?></td>
                                <td><?= $data->code ?></td>
            ...
            <div class="modal-body">
                <form id="ekpsedisiForm">
                    <div class="row g-3">
                        <div class="col-xxl-6">
                            <div>
                                <label for="name" class="form-label">Dest. Code</label>
                                <input type="text" class="form-control" id="code" name="code" placeholder="" required>
                            </div>
                            <div>
                                <label for="name" class="form-label">Dest. Name</label>
