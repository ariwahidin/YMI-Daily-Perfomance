        ...
        ?>
            <tr>
                ...
                <td>
                    ...
                    data-date="<?= $data->date ?>" 
                    data-start-date="<?= date('Y-m-d', strtotime($data->start_time)) ?>" 
                    data-end-date="<?= date('Y-m-d', strtotime($data->end_time)) ?>" 
                    data-start-time="<?= date('H:i', strtotime($data->start_time)) ?>" 
                    data-end-time="<?= date('H:i', strtotime($data->end_time)) ?>">Edit</button>
